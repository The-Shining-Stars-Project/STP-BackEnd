...
namespace CRM.Persistence.Migrations
{
    ...
    [Migration("20260924224551_RosterAssignmentPerProgram")]
    partial class RosterAssignmentPerProgram
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Domain.Entities.CalendarEventSite", b =>
                {
                    ...
                    b.HasKey("CalendarEventId", "SiteId");

                    b.HasIndex("SiteId");

                    b.ToTable("CalendarEventSites", (string)null);
                });
            ...
            modelBuilder.Entity("CRM.Domain.Entities.EventSessionSite", b =>
                {
                    ...
                    b.HasKey("EventSessionId", "SiteId");

                    b.HasIndex("SiteId");

                    b.ToTable("EventSessionSites", (string)null);
                });
            ...
            modelBuilder.Entity("CRM.Domain.Entities.Participant", b =>
                {
                    ...
                    b.Property<string>("SdpFmsName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("SdpIndependentFacilitator")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("SdpIndependentFacilitatorEmail")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<DateTime?>("SdpStartDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CRM.Domain.Entities.RosterAssignment", b =>
                {
                    ...
                    b.HasIndex("ParticipantId", "ProgramId", "Year", "Quarter")
                        .IsUnique();

                    b.ToTable("RosterAssignments");
                });

            modelBuilder.Entity("CRM.Domain.Entities.RosterAssignmentSite", b =>
                {
                    ...
                    b.HasKey("RosterAssignmentId", "SiteId");

                    b.HasIndex("SiteId");

                    b.ToTable("RosterAssignmentSites", (string)null);
                });
            ...
            modelBuilder.Entity("CRM.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastFailedMfaAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CRM.Domain.Entities.CalendarEventSite", b =>
                {
                    b.HasOne("CRM.Domain.Entities.CalendarEvent", "CalendarEvent")
                        .WithMany("Sites")
            ...
            modelBuilder.Entity("CRM.Domain.Entities.EventAttendanceRecord", b =>
                {
                    b.HasOne("CRM.Domain.Entities.EventSession", "EventSession")
                        .WithMany("AttendanceRecords")
            ...
            modelBuilder.Entity("CRM.Domain.Entities.RosterAssignmentSite", b =>
                {
                    b.HasOne("CRM.Domain.Entities.RosterAssignment", "RosterAssignment")
                        .WithMany("Sites")
                        .HasForeignKey("RosterAssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
